...
export const listArticle = [
  ...
  },
  {
    ...
    Blockchain technology sits at the center of technologies that are currently being integrated. It’s ledger for agreement, exchange, and incentivization. 
    The code of ethics looks at 50 ethics in 10 areas to vote on and discuss where we’re going and what guardrails need to be created.
    ...
    It’s important to remember that ALL PEOPLE ARE STAKEHOLDERS OF TECHNOLOGY. ALL. 
    `,
    "image": 'https://cdn.pixabay.com/photo/2019/11/25/17/05/new-years-eve-4652544_960_720.jpg',
    "createdAt": '2019-06-02T04:55:19.411Z',
    "updatedAt": '2019-12-09T04:55:19.411Z',
    "reactionsCounts": {
      "likes": 30,
